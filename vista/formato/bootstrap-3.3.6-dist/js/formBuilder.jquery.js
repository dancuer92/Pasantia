...
(function ($) {
    ...
    $.fn.formBuilder = function (options) {
        ...
        var bindSettings = function () {
            ...
            /* TABLE
             * 
             * Esto va para el manejo de la tabla, ocultar y mostrar el panel de configuraciones y demas opciones
             * que se tendran en cuenta en la tabla como adicionar columna y fila.
             * 
             */


            if (currentlySelected.data('type') == 'element-table') {
                $('#table-options').css('display', 'block');
//                $('#table').val(currentlySelected.children('.description').html());

                $('table').each(function (i) {                    
                    var nombre = 'tabla' + i;
                    $(this).attr('id', nombre);
                    console.log(nombre);
                    console.log($(this).attr('id', nombre));
                });
                var tabla = "#" + currentlySelected.children('table').attr('id') + " tbody";

                $("#agregarFila").click( function () {                    
                    var columnasTabla = tabla + " tr:last td";
...
//debugger;
                ...
                $("#agregarColumna").click(function () {
                    var filasTabla = tabla + " td:last";

                    $(filasTabla).each(function (i) {
                        console.log(filasTabla);
                        $(tabla).children('tr').append("<td>Hola columna</td>");
                    });
                });
            }
            else {
            ...
            $('#sortable-elements li').each(function (i) {
                ...
                if (element['type'] == 'element-multiple-choice' || element['type'] == 'element-checkboxes' || element['type'] == 'element-dropdown') {
                    ...
                    if( element['type']== 'element-table'){
                        var table = $(this).children('table').attr('id').tableToJSON();                        
                    }
                }
