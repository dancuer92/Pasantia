    ...
    <nav>
        ...
        <div class="nav-wrapper "  id="navbarUsers">            
            ...
            <ul class="right hide-on-med-and-down"> 
                <li><a href="index.php" class="waves-effect waves-light colorTexto"> Inicio</a></li>
                <li><a href="usuario.php" class="waves-effect waves-light colorTexto"> Usuario</a></li>
                <li><a href="formato.php" class="waves-effect waves-light colorTexto"> Formato</a></li>
                <!-- Dropdown Trigger -->
                <li>                    
